 ...
 * @param {string} options.allowedType - Type of characters allowed (ALPHABET, ALPHANUMERIC, SYMBOLS)
 * @param {boolean} options.escapeHTML - Whether to escape HTML special characters
